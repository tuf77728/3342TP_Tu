...
namespace Utilities
{
    ...
    {
        //String SqlConnectStringTunneling = "server=127.0.0.1,5555;Database=sp16_3342_tuf77728;User id=tuf77728;Password=Wohnooj9";//tunelling!

        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp16_3342_tuf77728;User id=tuf77728;Password=Wohnooj9";



        //this version causes errors 
        //String SqlConnectStringTunneling = "server=cis-mssql1.temple.edu;Database=sp16_3342_tud14718;User id=tud14718;Password=Iothom3a";

        //test **wow**
        String SqlConnectStringTunneling = "server=127.0.0.1,5555;Database=sp16_3342_tud14718;User id=tud14718;Password=Iothom3a";
        ...
        public DBConnect()
        {
            ...
            myConnectionSql = new SqlConnection(SqlConnectStringTunneling);//tunelling
        }

        public DataSet GetDataSet(String SqlSelect)//used in project2
        {
        ...
        public int DoUpdate(String SqlManipulate)//used in project2
        {
